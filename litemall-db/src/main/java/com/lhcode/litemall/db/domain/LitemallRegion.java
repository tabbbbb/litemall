...
@ApiModel(value = "LitemallRegion",description = "区域信息")
public class LitemallRegion {
     ...
     * @mbg.generated
     */
    @ApiModelProperty("区域邮政编码")
    private Integer code;


    @ApiModelProperty("下属区域")
    private List<LitemallRegion>  children;

    public List<LitemallRegion> getChildren() {
        return children;
    }

    public void setChildren(List<LitemallRegion> children) {
