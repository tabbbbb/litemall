package com.lhcode.litemall.core.system;

import com.lhcode.litemall.core.util.SystemInfoPrinter;
...
class SystemInistService {
    ...
    static {
        ...
        DEFAULT_CONFIGS.put(SystemConfig.LITEMALL_DOWN_PAYMENT, "50");
    }
