package com.lhcode.litemall.admin.util;
...
public class AdminResponseCode {
     ...
     * VIP类型数量超过额定值
     */
    public static final Integer VIP_COUNT_EXCEED = 651;


    /**
     * 无效的用户ID
     */
    public static final Integer INVALID_USER_ID = 652;
     ...
     * 用户id为空
     */
    public static final Integer USER_ID_NULL = 653;



    public static final Integer ADMIN_ROLE = 000;
